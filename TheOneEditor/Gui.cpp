...
//	bool p_open = true;
//	ImGui::Begin("TOE Dockspace", &p_open, window_flags);
//
...
//	}
//
//	if (ImGui::Button("Play"))  app->Play();	ImGui::SameLine();
//	if (ImGui::Button("Pause")) app->Pause();	ImGui::SameLine();
//	if (ImGui::Button("Stop"))  app->Stop();	ImGui::SameLine();
//
