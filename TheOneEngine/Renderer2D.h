...
public:
	...
	static void DrawQuad(const glm::vec2& position, const glm::vec2& size, std::shared_ptr<Texture> sprite, float tilingFactor = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f));
	...
	static void DrawQuad(const glm::mat4& transform, std::shared_ptr<Texture> sprite, float tilingFactor = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f));
