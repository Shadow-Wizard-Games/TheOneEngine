...
public:
	...
	static void DrawQuad(const glm::vec3& position, const glm::vec2& size, ResourceId imageID, const TexCoordsSection& texCoords, float tilingFactor = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f));
	...
	static void DrawQuad(const glm::mat4& transform, ResourceId imageID, const TexCoordsSection& texCoords, float tilingFactor = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f));
